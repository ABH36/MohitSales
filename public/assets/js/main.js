!(function (e) {
    ...
    e(window).on("load", function () {
        ...
        // }),
        e("body").append(
            '<div class="rs-theme-settings-area">\n        <div class="rs-theme-wrapper">\n        <div class="rs-theme-header text-center">\n           <h4 class="rs-theme-header-title">Template Settings</h4>\n        </div>\n        <div class="rs-theme-dir">\n           <label class="rs-theme-dir-main" for="rs-dir-toggler">\n              <span class="rs-theme-dir-rtl"> RTL</span>\n                 <input type="checkbox" id="rs-dir-toggler">\n                 <i class="rs-theme-dir-slide"></i>\n              <span class="rs-theme-dir-ltr"> LTR</span>\n           </label>\n        </div>\n\n        <div class="rs-theme-settings">\n           <div class="rs-theme-settings-wrapper">\n              <!-- Removed the button to open the settings area -->\n           </div>\n        </div>\n     </div>\n         </div>'
        );
        
        e("#rs-dir-toggler").length > 0 &&
            (function () {
                function t(t) {
                    localStorage.setItem("rs_dir", t), document.documentElement.setAttribute("dir", t), "rtl" === t ? e("body").addClass("rtl") : e("body").removeClass("rtl");
                    var a = e("[href='assets/vendor/css/bootstrap.min.css']");
                    e(a).attr("href", "rtl" === t ? "assets/vendor/css/bootstrap.rtl.min.css" : "assets/vendor/css/bootstrap.min.css");
                }
                var a;
                e("#rs-dir-toggler").on("change", function () {
                    "rtl" === localStorage.getItem("rs_dir") ? t("ltr") : t("rtl"), location.reload(!0);
                }),
    ...
    e(window).on("load", function (t) {
        e("#pre-load").delay(600).fadeOut(500), e(".pre-loader").delay(600).fadeOut(500);
    });
    ...
    t && (t.innerHTML = new Date().getFullYear()),
        e(".offcanvas-close,.offcanvas-overlay").on("click", function () {
            e(".offcanvas-area").removeClass("info-open"), e(".offcanvas-overlay").removeClass("overlay-open");
        }),
        e(".sidebar-toggle").on("click", function () {
            e(".offcanvas-area").addClass("info-open"), e(".offcanvas-overlay").addClass("overlay-open");
        }),
        e(".body-overlay").on("click", function () {
            e(".offcanvas-area").removeClass("opened"), e(".body-overlay").removeClass("opened");
        }),
        ...
        e(".rs-pricing-area").each(function () {
            ...
            e(a).on("click", function () {
                i.prop("checked", !0), e(this).addClass("active").parent(".rs-pricing-tab").siblings().children().removeClass("active"), n.css("display", "block"), s.css("display", "none");
            }),
                e(t).on("click", function () {
                    i.prop("checked", !1), e(this).addClass("active").parent(".rs-pricing-tab").siblings().children().removeClass("active"), n.css("display", "none"), s.css("display", "block");
                });
        }),
        ...
        e(".rs-header-search-icon").on("click", function (t) {
            e(".rs-stickys-form").slideToggle("show"), e(this).toggleClass("icon-close");
        }),
        document.addEventListener("DOMContentLoaded", function () {
            function e(e) {
                var t = e.clientX,
                    a = e.clientY,
                    n = e.currentTarget,
                    s = n.querySelector(".rs-portfolio-tooltip .rs-portfolio-tooltip-content"),
            ...
            document.querySelectorAll(".rs-portfolio-tooltip .rs-portfolio-tooltip-item").forEach(function (t) {
        ...
        e(document).ready(function () {
            e(".rs-button-wrapper .rs-btn").mouseenter(function () {
                ...
                e(".rs-button-wrapper .rs-btn").mouseleave(function () {
                    e(this).find(".rs-icon").css("animation", "btnHoverEffectReverse 0.5s");
                }),
                e(".rs-text-circle").length &&
                    e(".rs-text-circle").each(function () {
                        for (var t = e(this).text().replace(/\s+/g, " ").trim(), a = "", n = 0; n < t.length; n++) a += "<span>" + t[n] + "</span>";
                        e(this).html(a);
                ...
                e(".rs-swiper .swiper").each(function (t) {
                    if (e(this).hasClass("react-managed")) return;
                    var a = e(this),
                        n = void 0 === a.data("hover-pause") || a.data("hover-pause"),
                        s = void 0 === e(this).data("loop") || e(this).data("loop"),
                        i = void 0 !== e(this).data("center-mode") && e(this).data("center-mode"),
                        o = void 0 === e(this).data("autoplay") || e(this).data("autoplay"),
                        r = void 0 === e(this).data("dots-dynamic") || e(this).data("dots-dynamic"),
                        l = "vertical" === e(this).data("direction") ? "vertical" : "horizontal",
                        c = void 0 === e(this).data("play-slide") || e(this).data("play-slide"),
                        d = e(this).data("effect") || "slide",
                        p = void 0 !== e(this).data("grab-cursor") && e(this).data("grab-cursor"),
                        ...
                        L = e(this).data("margin-mobile") ? e(this).data("margin-mobile") : T,
                        D = `rs-nav-prev-${t}`,
                        P = `rs-nav-next-${t}`;
                    a.closest(".rs-swiper").find(".swiper-button-prev").addClass(D), a.closest(".rs-swiper").find(".swiper-button-next").addClass(P);
            ...
            var t = new Swiper(".product-details-nav", { spaceBetween: -20, slidesPerView: 4, navigation: { nextEl: ".product-details-button-next", prevEl: ".product-details-button-prev" } });
            new Swiper(".product-details-active", { spaceBetween: 0, thumbs: { swiper: t }, navigation: { nextEl: ".product-details-button-next", prevEl: ".product-details-button-prev" } });
            ...
            if (e("#slider-range").length) {
                noUiSlider.create(i, { start: [0, 1100], connect: !0, range: { min: 0, max: 2500 } });
            ...
            jQuery(".rs-ripple-item").each(function (e) {
                ...
                jQuery(this).on("click", function () {
                    n.hasClass("active") ? n.removeClass("active") : (a.find(".mobile_item.active").removeClass("active"), n.addClass("active"));
                }),
            ...
            function c() {
                v = setInterval(function () {
                    r.eq(l).removeClass("ripple"), (l = (l + 1) % r.length), r.eq(l).addClass("ripple");
                }, 1500);
            }
            c(),
                r
                ...
                e("#pie-chart").length &&
                    new Chart(document.getElementById("pie-chart"), {
                        ...
                        data: {
                            ...
                            datasets: [{ backgroundColor: ["#0D80CE", "#5CC8BE", "#3B37FD", "#EE0D08", "#EA5501"], data: ["16", "36", "46", "56", "76"] }],
                        },
                        options: { responsive: !0, layout: { padding: 0 }, plugins: { legend: { position: "left", labels: { color: "#1F1F1F", padding: 15, boxWidth: 12, boxHeight: 12, font: { size: 15, weight: 600 } } } } },
                    });
            ...
            function p(t, a) {
                ...
                if (s <= 0)
                    return (
                        ...
                        e("#" + a + " [data-unit='minutes']").html("00<span>Minutes</span>"),
                        void e("#" + a + " [data-unit='seconds']").html("00<span>Seconds</span>")
                    );
                ...
                o < "10" && (o = "0" + o),
                    ...
                    e("#" + a + " [data-unit='minutes']").html(r + "<span>Minutes</span>"),
                    e("#" + a + " [data-unit='seconds']").html(l + "<span>Seconds</span>");
            }
            document.querySelectorAll(".multipage-menu a").forEach((e) => {
                ...
                if (t === d || ("" === d && "index.html" === t)) {
                    ...
                    for (; t; ) "LI" === t.tagName && t.classList.add("active"), (t = t.parentElement);
                }
            }),
                // e("#mobile-menu").meanmenu({ meanMenuContainer: ".mobile-menu", meanScreenWidth: "1199", meanExpand: ['<i class="fa-regular fa-plus"></i>'] }),
                e(".onepage-menu li a").on("click", function () {
                    e(".onepage-menu li a.active").removeClass("active"), e(this).addClass("active"), e(".offcanvas-area").removeClass("info-open"), e(".offcanvas-overlay").removeClass("overlay-open");
                });
            var u = new Date("5 August 2025 14:00:00 GMT+06:00");
            u = Date.parse(u) / 1e3;
            var m = setInterval(function () {
                p(u, "countdown1"), p(u, "countdown2"), p(u, "countdown3"), p(u, "countdown4"), p(u, "countdown5");
            }, 1e3);
            if (e(".rs-services-tab-wrapper.auto-switch").length) {
                var h,
                    v = 5e3;
                function f() {
                    var t = e(".rs-services-tab-wrapper.auto-switch .nav-item .nav-link.active").closest(".nav-item").next(".nav-item").find(".nav-link");
                    t.length || (t = e(".rs-services-tab-wrapper.auto-switch .nav-item").first().find(".nav-link")), t.trigger("click");
                }
                function g() {
                    h = setInterval(f, v);
                }
                g(),
                    e(".rs-services-tab-wrapper.auto-switch").on("mouseenter", function () {
                        clearInterval(h);
                    }),
                    e(".rs-services-tab-wrapper.auto-switch").on("mouseleave", function () {
                        g();
                    });
            }
        }),
    ...
    new Swiper(".rs-marquee-slide", { spaceBetween: 0, centeredSlides: !0, speed: 1e4, autoplay: { delay: 1 }, loop: !0, slidesPerView: "auto", allowTouchMove: !1, disableOnInteraction: !0 });
    if (e(".portfolio-load-more").length > 0)
        e(".grid").imagesLoaded(function () {
            var t = e(".grid").isotope({ itemSelector: ".grid-item", percentPosition: !0, masonry: { columnWidth: ".grid-item" } });
            ...
            function s(a) {
                ...
                var s = n.filteredItems.slice(a, n.filteredItems.length).map(function (e) {
                    return e.element;
                });
        ...
        e(".featured-load-item").hide(),
            ...
            e("body").on("click touchstart", ".load-more", function (t) {
                t.preventDefault(), e(".featured-load-item:hidden").slice(0, a).slideDown(), 0 == e(".featured-load-item:hidden").length && e(".load-more").css("display", "none");
            });
    }
    ...
    if (
        ...
        const o = new Lenis({ smoothWheel: !0, wheelMultiplier: 1.2, duration: 1.5, lerp: 0.1 });
        function r(e) {
    ...
    new Swiper(".text-slide-one", { loop: !0, freemode: !0, slidesPerView: 4, spaceBetween: 0, allowTouchMove: !1, speed: 1e4, autoplay: { delay: 1, disableOnInteraction: !0 } });
    ...
    e(s).submit(function (t) {
        ...
        e.ajax({ type: "POST", url: e(s).attr("action"), data: a })
            ...
            .fail(function (t) {
                e(i).removeClass("success"), e(i).addClass("error"), "" !== t.responseText ? e(i).text(t.responseText) : e(i).text("Oops! An error occurred and your message could not be sent.");
            });
    });
})(jQuery);
