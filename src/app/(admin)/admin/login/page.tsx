    ...
    <div className="min-h-screen flex" style={{ backgroundColor: '#0d2b2b' }}>
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center px-10 py-12 relative">
        ...
        <div className="md:hidden flex flex-col items-center mb-10">
          <img src={cld("https://res.cloudinary.com/da2dmtm9b/image/upload/v1783167908/mohit/logo/msc_logo_without_bg.png", "f_auto,q_auto,w_320")} alt="MSC" className="w-16 h-16 object-contain mb-3" />
