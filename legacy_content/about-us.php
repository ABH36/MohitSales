...
<head>
    ...
    <title>About Us - Mohit Sales Corporation Pvt. Ltd.</title>
...
<body class="rs-smoother-yes rtl">
    ...
    <main>
        ...
        <section class="about-inner">
            <div class="container">
                <div class="row">
                    ...
                    <div class="prabhat-about" id="prabhat-wire-llp">
                        ...
                        <div class="core-values llp">
                            ...
                            <div class="brand-table-wrapper">
                                <table class="brand-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="brand-name polycab">Polycab</td>
                                            <td>
                                                <ul>
                                                    <li>Cables</li>
                                                    <li>Switchgears</li>
                                        ...
                                        <tr>
                                            <td class="brand-name dowells">Dowells</td>
                                            <td>
                                                <ul>
                        ...
                        <div class="core-values">
                            <h4>Mission</h4>
                            <ul>
                                <li><i class="fa-solid fa-arrow-right-long"></i>To provide <strong>top-quality electrical products</strong> through strong partnerships with leading brands.</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>To ensure <strong>unmatched customer satisfaction</strong> with timely delivery, expert guidance, and professional service.</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>To strengthen our network and deliver <strong>cost-effective, safe, and energy-efficient solutions.</strong></li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>To embrace new technologies and market trends to support the nation’s <strong>electrical and infrastructure growth.</strong> </li>
                            </ul>
                        </div>
                        ...
                        <div class="core-values mt-3">
                            <h4>Core Values</h4>
                            <ul>
                                <li><i class="fa-solid fa-arrow-right-long"></i> <strong>Integrity</strong>- We commit to transparency and ethical business practices. </li>
                                <li><i class="fa-solid fa-arrow-right-long"></i><strong>Quality</strong>- We deliver only genuine and reliable products from top global brands.</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i><strong>Customer Focus </strong>- Your requirements drive our actions.</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i><strong>Reliability</strong>- On-time supply and trustworthy service, always.</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i><strong>Innovation </strong>- Adapting to new technologies and market needs.</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i><strong>Long-Term Relationships </strong>- Building partnerships backed by trust and performance.</li>
                            </ul>
                        </div>
                        ...
                        <div class="core-values mt-3">
                            <h4>Why Choose Us?</h4>
                            <ul>
                                <li><i class="fa-solid fa-arrow-right-long"></i> 27+ years of industry expertise </li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>Authorised distributor for leading global brands</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>Wide product range with strong inventory and fast delivery</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>Technical product knowledge and support</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>Trusted by contractors, industries, and infrastructure developers</li>
                        ...
                        <div class="core-values mt-3">
                            ...
                            <ul>
                                <li><i class="fa-solid fa-arrow-right-long"></i> Residential & Commercial Projects</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>Industrial Manufacturing</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>Infrastructure & Construction</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>Renewable Energy Projects</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>Oil & Gas</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>OEMs</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>EPC Contractors</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i>Retail Electrical Markets</li>
            ...
            <div class="container">
                <div class="row">
                    <div class="partner-details">
                        <h4>Our Banking Partner</h4>
                        <div class="partner-logo">
                            <img src="<?php echo BASE_URL . 'assets/images/logo/state-bank-of-india-logo.png'; ?>"
                                class="state-bank-of-india-logo" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- about area start -->
        <section class="rs-about-area section-space rs-about-twelve d-none">
            <div class="container">
                <div class="row  g-5 justify-content-center section-title-space align-items-center">
                    <div class="col-xxl-8 col-xl-9 col-lg-9">
                        <div class="rs-section-title-wrapper text-center">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">Welcome to Industrie, a
                                leading
                                industry innovator with a rich history of excellence.</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-content">
                                ...
                                <p>Welcome to Industrie, a leading industry innovator with a rich history of excellence.
                                    With a
                                    passion for precision.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-content">
                                ...
                                <p>We have been empowering industries and driving progress for over 30 years. Our
                                    diverse team
                                    of experts brings together.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- history area start -->
        <section class="rs-history-area section-space rs-history-one d-none">
                                        ...
                                        <div class="rs-history-tab-item">
                                            ...
                                            <div class="rs-history-tab-content">
                                                ...
                                                <p>
                                                    ...
                                                    history of
                                                    excellence. With a passion for precision and a commitment to
                                                    quality, we have
        ...
        <!-- team area start -->
        <section class="rs-team-area section-space rs-team-one d-none">
            <div class="container">
                <div class="row  g-5 section-title-space align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-team-btn d-flex justify-content-lg-end">
                            <a class="rs-btn has-theme-orange has-icon has-bg" href="team.html">Become a Member
                                <span class="icon-box">
        ...
        <!-- counter area start -->
        <section class="rs-counter-area rs-counter-one section-space-top has-space p-relative z-index-1 d-none">
        ...
        <!-- progress area start -->
        <section class="rs-progress-area rs-progress-one has-space section-space-bottom d-none">
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-progress-wrapper">
                            <div class="rs-progress-bg-thumb"
                                data-background="assets/images/progress/progress-thumb-02.png"> </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="rs-progress-thumb">
                            <img src="assets/images/progress/progress-bar-thumb-02.png" alt="image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="rs-testimonial-area rs-testimonial-three rs-swiper has-bg-black d-none">
                    ...
                    <div class="col-xxl-6 col-xl-7 col-lg-7">
                        <div class="rs-testimonial-wrapper">
                            <div class="rs-section-title-wrapper section-title-space">
                                <span
                                    class="rs-section-subtitle has-theme-orange justify-content-start has-transparent">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15"
                                        fill="none">
                                        <path d="M3.14286 10L0 15L8.78104e-07 0L3.14286 5V10Z" fill="#EA5501"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <!-- brand area start -->
        <section class="rs-brand-area section-space rs-brand-two has-theme-orange d-none">
                    ...
                    <div class="col-12">
                        <div class="rs-brand-wrapper">
                            <div class="rs-section-title-wrapper">
                                ...
                                <h2 class="rs-section-title rs-split-text-enable split-in-fade mb-20">Our clients and
                                    partners </h2>
        ...
        <!-- blog area start -->
        <section class="rs-blog-area section-space rs-blog-two has-theme-orange rs-swiper d-none">
            <div class="container">
                                ...
                                <div class="rs-blog-item">
                                    ...
                                    <div class="rs-blog-content">
                                        ...
                                        <h5 class="rs-blog-title underline has-black"> <a
                                                href="blog-details.html">Construction of a
