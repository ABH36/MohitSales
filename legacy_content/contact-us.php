...
<head>
    ...
    <title>Contact Us - Mohit Sales Corporation Pvt. Ltd.</title>
    ...
    <main>
        ...
        <section class="rs-breadcrumb-area rs-breadcrumb-one p-relative">
            <div class="rs-breadcrumb-bg"
                data-background="<?php echo BASE_URL . 'assets/images/inner-banner/contact-us.png'; ?>"></div>
            <div class="container">
                <div class="row">
        ...
        <!-- contact area start -->
        <section class="rs-contact-area rs-contact-eight section-space-top d-none">
            <div class="container">
                ...
                <div class="row contact">
                    <div class="col-lg-3">
                        <div class="rs-contact-item">
                            ...
                            <div class="rs-contact-content">
                                ...
                                <a href="https://maps.app.goo.gl/3oEyjo8ZYNDEhECH6"> 54/2/16 &<br> 54/2/18 Siddharth Farms Lasudia Mori Dewas Naka <br>
                                                Indore-452010</a>
                            </div>
                        </div>
                      ...
                      <div class="col-lg-3">
                        <div class="rs-contact-item">
                            ...
                            <div class="rs-contact-content">
                                ...
                                <p> Mon - Sat 10.00 AM - 06.30 PM <br>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="rs-contact-item">
                            ...
                            <div class="rs-contact-content">
                                <h5 class="rs-contact-title">Mail Us</h5>
                    ...
                    <!-- <div class="col-12">
                        <div class="rs-contact-wrapper">
                            <div class="rs-contact-item">
                                ...
                                <div class="rs-contact-content">
                                    <h5 class="rs-contact-title">Office Address </h5>
                                    <a href="#">1st Floor
                                        , Govind
                                        Niwas 99/101, Lohar Chawl Mumbai , Maharashtra , India - 400002.</a>
                                </div>
                            </div>
                            ...
                            <div class="rs-contact-item">
                                ...
                                <div class="rs-contact-content">
                                    <h5 class="rs-contact-title">Mumbai
                                        (Wires) </h5>
                                    <a href="#">Shop No.2, Ground Flr, 9/11, Bhulakidas Bldg,<br /> Vithaldas Road,
                                        Lohar
                                        Chawl, Mumbai- 400 002</a>
                                </div>
                            </div>
                            ...
                            <div class="rs-contact-item">
                                ...
                                <div class="rs-contact-content">
                                    <h5 class="rs-contact-title">Mumbai
                                        (Cables)</h5>
                                    <a href="#">Shop No.G-11, Bldg-8,<br /> Devkaran Mansion,<br /> Vithaldas Road,
                                        Lohar
                                        Chawl,
                                        Mumbai- 400 002</a>
                                </div>
                            ...
                            <div class="rs-contact-item">
                                ...
                                <div class="rs-contact-content">
                                    <h5 class="rs-contact-title">Bhiwandi</h5>
                                    <a href="#">Survey No-25/5 & 6, <br />House No- 377, Dapode Road, Bhiwandi- 421
                                        302</a>
                                </div>
                            </div>
                ...
                <!-- <div class="row contact mt-4">
                    <div class="col-lg-3">
                        <div class="rs-contact-item">
                            ...
                            <div class="rs-contact-content">
                                <h5 class="rs-contact-title">Opening Hour </h5>
                                <p> Mon - Sat 09.00 AM - 06.00 PM <br>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="rs-contact-item">
                            ...
                            <div class="rs-contact-content">
                                <h5 class="rs-contact-title">Mail Us</h5>
                                <a href="mailto:sales@prabhatwires.in">sales@prabhatwires.in</a>
                    ...
                    <div class="col-lg-3">
                        <div class="rs-contact-item">
                            ...
                            <div class="rs-contact-content">
                                <h5 class="rs-contact-title">Call Us </h5>
                                <a href="tel:912249724848">+91 22 4972 4848</a>
        ...
        <section class="rs-contact-form-area rs-contact-ten section-space-bottom" id="contact-us-form">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="rs-contact-form">
                            <h3 class="rs-contact-form-title">Get in Touch</h3>
                            <p class="descrip">Whether you have questions, feedback, or just want to say hello, we're
                                always happy to hear from you. Choose a convenient method below to get in touch.</p>
                            <form id="enquiry-form" method="POST" enctype="multipart/form-data">
                                <div class="row g-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="rs-contact-input">
                                            <input id="name" name="cname" type="text" placeholder="Company Name"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="rs-contact-input">
                                            <input id="phone" name="mobile" type="text" placeholder="Phone Number"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-start">
                                     ...
                                     <div class="rs-contact-input col-md-6 d-flex align-items-center gap-2">
                                                <span class="captcha-box"
                                                    id="captchaValue2"><?php echo htmlspecialchars($_SESSION['captcha']); ?></span>
                                                <span class="captcha-refresh" id="refreshCaptcha2"
                                                    style="cursor:pointer;">Refresh</span>
...
<?php include ROOT_PATH . '/common/scripts.php'; ?>
    ...
    //         var submitBtn = $("#enquiry-form :submit");
