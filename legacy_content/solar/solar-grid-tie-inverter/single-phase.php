...
<head>
    ...
    <title>Single Phase - Mohit Sales Corporation Pvt. Ltd.</title>
                ...
                <section class="products-section">
                    <div class="container">
                        ...
                        <div class="row product-wrapper">
                            <div class="col-12">
                                <h4 class="text-center mb-4">SINGLE PHASE SOLAR GRID TIE INVERTERS 1 – 5 KW</h4>
                                <div class="card_box">
                                    <div class="row align-items-center product-card">

                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/solar/single_phase/single-phase-v2.png'; ?>"
                                                alt="Single Phase" class="product-img">
                                            <h3 class="product-title">Single Phase</h3>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="specs-box">
                                                ...
                                                <ul class="specs-list">
                                                    <li>More reliable and efficient with world-class components for 20 years design life</li>
                                                    <li>High-frequency switching technology</li>
                                                    <li>Low Start-up Voltage & Ultra Wide MPPT Range for More Power Generation</li>
                                                    <li>Multiple Protection Level</li>
                                                    <li>THDi &lt; 3%</li>
                                                    <li>Max. Efficiency 98.1%</li>
                                                    <li>Built-in Export Power Management for Export Control</li>
                                                    <li>IP65 for Outdoor Installation</li>
                                                    <li>Compact Size & Light Weight Design for Single Person Installation</li>
                                                    <li>RS-485; Wi-Fi / GPRS / LAN Interface (Optional)</li>
