...
<head>
    ...
    <title>DC MCB - Mohit Sales Corporation Pvt. Ltd.</title>
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/solar/DC-MCB-2.png'; ?>"
                                                alt="DC MCB" class="product-img">
                                            <h3 class="product-title">DC MCB</h3>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="specs-box">
                                                ...
                                                <ul class="specs-list">
                                                    ...
                                                    <li>Quick in tripping off when current exceeds</li>
                                                    <li>Current exceeds protection</li>
                                                    <li>Low maintenance</li>
                                                    <li>High reliability</li>
                                                    <li>Commandable short circuit protection</li>
                                                    <li>Ease of operations</li>
                                                    <li>Suitable for industrial as well as residential operations</li>
                                                    <li>Indian safety standards tested</li>
                                                    <li>Maintenance free operations</li>
                                                </ul>
