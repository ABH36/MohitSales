...
<head>
    ...
    <title>Solar Grid Tie Inverter - Mohit Sales Corporation Pvt. Ltd.</title>
                            ...
                            <div class="rs-breadcrumb-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><span>Solar Grid Tie Inverter</span></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="products-grid">
                            ...
                            <div class="product-card">
                                <a href="<?php echo BASE_URL . 'solar/solar-grid-tie-inverter/single-phase.php'; ?>">
                                    <img src="<?php echo BASE_URL .'assets/images/our_products/solar/single_phase/single-phase-v2.png'?>" alt="Product">
                                    <h3>Single Phase</h3>
                            ...
                            <div class="product-card">
                                <a href="<?php echo BASE_URL . 'solar/solar-grid-tie-inverter/three-phase.php'; ?>">
                                    <img src="<?php echo BASE_URL .'assets/images/our_products/solar/single_phase/three-phase-v2.png'?>" alt="Product">
                                    <h3>Three Phase</h3>
                                    <div class="pricelist-button">
                                        <span class="pricelist-btn">Explore More</span>
                                    </div>
