...
<head>
    ...
    <title>Conduit & Accessories - Mohit Sales Corporation Pvt. Ltd.</title>
                    ...
                    <div class="container">
                        ...
                        <div class="products-grid">
                            ...
                            <div class="product-card">
                                <a href="<?php echo BASE_URL . 'conduit-accessories/upvc-conduit.php'; ?>">
                                    <img src="<?php echo BASE_URL . 'assets/images/our_products/conduit_accessories/CONDUITS.png'?>" alt="Product">
                                    <h3>UPVC Conduit</h3>
                            ...
                            <div class="product-card">
                                <a href="<?php echo BASE_URL . 'conduit-accessories/concealed-box.php'; ?>">
                                    <img src="<?php echo BASE_URL . 'assets/images/our_products/conduit_accessories/Concealed-Box.png'?>" alt="Product">
                                    <h3>Concealed Box</h3>
                                    <div class="pricelist-button">
                                        <span class="pricelist-btn">Explore More</span>
                                    </div>
