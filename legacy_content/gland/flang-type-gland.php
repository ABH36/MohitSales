...
<head>
    ...
    <title>Flang Type Gland - Mohit Sales Corporation Pvt. Ltd.</title>
                            ...
                            <div class="rs-breadcrumb-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><span>Flang Type Gland</span></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="product-card">
                            <div class="product-img">
                                <img src="<?php echo BASE_URL . 'assets/images/our_products/gland/3.jpg' ?>" alt="" class="img-fluid">
                            </div>

                            <div class="product-content">
                                <div class="product-title">Flang Type Gland</div>

                                <div class="product-details">
                                    <span>Material:</span> BRASS<br>
                                    <span>Finishing:</span> BRASS NATURAL<br>
                                    <span>Size:</span> 12-16mm to 67.1-76mm diameter
