...
<head>
    ...
    <title>Shrouds - Mohit Sales Corporation Pvt. Ltd.</title>
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="product-card">
                            <div class="product-img">
                                <img src="<?php echo BASE_URL . 'assets/images/our_products/gland/4.jpg' ?>" alt="" class="img-fluid">
                            </div>

                            <div class="product-content">
                                <div class="product-title">Shrouds</div>

                                <div class="product-details">
                                    <span>Material:</span> PVC<br>
