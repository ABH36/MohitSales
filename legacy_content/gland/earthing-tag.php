...
<head>
    ...
    <title>Earthing Tag - Mohit Sales Corporation Pvt. Ltd.</title>
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="product-card">
                            <div class="product-img">
                                <img src="<?php echo BASE_URL . 'assets/images/our_products/gland/5.jpg' ?>" alt="" class="img-fluid">
                            </div>

                            <div class="product-content">
                                <div class="product-title">Earthing Tag</div>

                                <div class="product-details">
                                    <span>Material:</span> BRASS,ALUMINIUM<br>
                                    <span>Finishing:</span> NATURAL<br>
                                    <span>Size:</span> Suitable for Double Compression Gland
