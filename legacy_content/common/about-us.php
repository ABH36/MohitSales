            ...
            <div class="container">
                <div class="row">
                    <div class="about-heading">
                        <h2>Welcome to Our World of Trusted Electrical Solutions</h2>
                    </div>
                    <div class="about-inner-content">
                        <p>At Mohit Sales Corporation Pvt. Ltd. and Mohit Sales Corporation Pvt. Ltd. AK Pvt. Ltd., we go beyond just delivering wires and
                            cables — we provide reliability, service, and long-lasting
                            connections. With decades of industry experience, a deep-rooted commitment to quality, and
                            partnerships with top brands like Polycab India Ltd.,
                            we’re here to power progress — safely, smartly, and sustainably.</p>
                    </div>
                    <div class="prabhat-about">
                        <h3>About Mohit Sales Corporation Pvt. Ltd.</h3>
                        <p>Limited Founded in 2018, Mohit Sales Corporation Pvt. Ltd. quickly established itself as a trusted
                            distributor
                            of wires and cables. Our focus has always been on providing customers with high-quality,
                            reliable electricalproducts from leading brands like Polycab India Ltd..</p>
                        <p>We serve a wide range of industries, from construction to manufacturing, offering everything
                            from power cables to specialty cables, with a strong commitment to customer service and
                            productexcellence.</p>

                        <div class="core-values">
                            <h4>Our Core Values</h4>
                            <ul>
                                <li><i class="fa-solid fa-arrow-right-long"></i><strong>Quality Assurance : </strong>
                                    Delivering only the best to our customers.</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i><strong>Customer-Centric
                                        Approach :</strong> We are driven
                                    by our clients' needs and ensure timely, efficient service.</li>
                                <li><i class="fa-solid fa-arrow-right-long"></i><strong>Reliability :</strong> Trusted
                                    for our consistent
                                    supply of top-grade products.</li>
                            </ul>
                        </div>

                        <div class="core-values llp">
                            <h4>Why Mohit Sales Corporation Pvt. Ltd. :</h4>
                            <p>As a pioneering player in the industry, we prioritize strong relationships and customer
                                trust. Our efficient logistics and proven expertise have made us a preferred choice in
                                the wires and cablesindustry.</p>
                        </div>
                    </div>
                </div>
            </div>
