 ...
 <!-- <div id="pre-load">
     <div id="loader" class="loader">
         <div class="loader-container">
             <div class="loader-icon"><img src="<?php echo BASE_URL . 'assets/images/favicon/favicon.png'; ?>" alt="">
             </div>
         </div>
     </div>
 </div> -->
 ...
 <!-- Header area start -->
 <header>
     <div class="rs-header-area rs-header-two header-transparent has-theme-orange has-border header-new"
         id="header-sticky">
             ...
             <div class="rs-header-inner">
                 <div class="rs-header-left">
                     <div class="rs-header-logo">
                         <a href="/"><img
                                 src="<?php echo BASE_URL . 'assets/images/logo/msc_logo_without_bg.png'; ?>" alt="logo" height="auto" width="250"></a>
                     </div>
                 </div>
                 <div class="rs-header-menu">
                     <nav id="mobile-menu" class="main-menu">
                         <ul class="multipage-menu">
                                   ...
                                   <ul class="submenu last-children">
                                       ...
                                       <li class="menu-item-has-children has-arrow">
                                           ...
                                           <ul class="submenu">
                                               ...
                                               <li><a href="blue-construction-one-page.html">Blue Construct Onepage</a>
                                               </li>
                                               <li><a href="metallurgy-one-page.html">Metallurgy Onepage</a></li>
                                               <li><a href="orange-construction-one-page.html">Construction Onepage</a>
                                               </li>
                             ...
                             <!-- <li>
                                 <a href="<?php echo BASE_URL . 'certificates.php'; ?>">Certificates</a>
                             </li> -->
                             <!-- page menu -->
                             <li class="menu-item-has-children d-none">
                                 <a href="javascript:void(0)">Consumers</a>
                                 <ul class="submenu last-children">
                                     <li class=" has-arrow">
                                         <a href="javascript:void(0)">House Wires</a>
                                         <ul class="submenu">
                                             <li><a
                                                     href="<?php echo BASE_URL . 'consumers/house-wires/polycabsuprema.php'; ?>">Polycabsuprema</a>
                                             </li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'consumers/house-wires/polycabmaxima-green-wire.php'; ?>">PolycabMaxima+
                                                     Green Wire</a>
                                             </li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'consumers/house-wires/polycabprimma.php'; ?>">PolycabPrimma</a>
                                             </li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'consumers/house-wires/etira.php'; ?>">Etira</a>
                                             </li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'consumers/house-wires/polycaboptima.php'; ?>">PolycabOptima+</a>
                                             </li>
                                         </ul>
                                     </li>
                                     <li class=" has-arrow">
                                         <a href="javascript:void(0)">180 METER</a>
                                         <ul class="submenu">
                                             <li><a
                                                     href="<?php echo BASE_URL . 'consumers/180-meter/greenwire-180m.php'; ?>">Greenwire
                                                     180M</a></li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'consumers/180-meter/polycab-lf-fr-180m.php'; ?>">Polycab
                                                     LF FR 180M</a></li>
                                         </ul>
                                     </li>
                             ...
                             <!-- <li class="menu-item-has-children">
                                 ...
                                 <ul class="submenu last-children">
                                     <li class=" has-arrow">
                                         <a href="javascript:void(0)">Cables by Application</a>
                                         <ul class="submenu">
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-application/building-infrastructure.php'; ?>">Building
                                                     Infrastructure</a></li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-application/energy-and-power-grid.php'; ?>">Energy
                                                     and Power Grid</a></li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-application/exploration-industries.php'; ?>">Exploration
                                                     Industries</a></li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-application/manufacturing-industries.php'; ?>">Manufacturing
                                                     Industries</a>
                                             </li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-application/mobility-infrastructure.php'; ?>">Mobility
                                                     Infrastructure</a>
                                             </li>
                                         </ul>
                                     </li>
                                     <li class=" has-arrow">
                                         <a href="javascript:void(0)">Cables by Standards</a>
                                         <ul class="submenu">
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-standards/indian-standards.php'; ?>">Indian
                                                     Standards (IS)</a></li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-standards/international-standards.php'; ?>">International
                                                     Standards</a>
                                             </li>
                                         </ul>
                                     </li>
                                     <li class=" has-arrow">
                                         <a href="javascript:void(0)">Cables by Type</a>
                                         <ul class="submenu">
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-type/lv-power-cable.php'; ?>">LV
                                                     Power Cable</a></li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-type/others.php'; ?>">Others</a>
                                             </li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-type/instrumentation-cable.php'; ?>">Instrumentation
                                                     Cable</a></li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-type/communication-and-data-cable.php'; ?>">Communication
                                                     & Data Cable
                                                 </a></li>
                                             <li><a
                                                     href="<?php echo BASE_URL . 'industries/cables-by-type/renewable-energy.php'; ?>">Renewable
                                                     Energy
                                                 </a></li>
                                             <li><a
                             ...
                             <li class="menu-item-has-children">
                                 ...
                                 <ul class="submenu last-children">
                                     ...
                                     <!-- 🔹 Polycab Category -->
                                     <li class="has-arrow">
                                         <a href="javascript:void(0)">Polycab</a>
                                         <ul class="submenu">
                                             ...
                                             <li class="has-arrow">
                                                 <a href="javascript:void(0)">Cables by Application</a>
                                                 <ul class="submenu">
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-application/building-infrastructure.php'; ?>">Building Infrastructure</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-application/energy-and-power-grid.php'; ?>">Energy and Power Grid</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-application/exploration-industries.php'; ?>">Exploration Industries</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-application/manufacturing-industries.php'; ?>">Manufacturing Industries</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-application/mobility-infrastructure.php'; ?>">Mobility Infrastructure</a></li>
                                                 </ul>
                                             </li>
                                             ...
                                             <li class="has-arrow">
                                                 <a href="javascript:void(0)">Cables by Standards</a>
                                                 <ul class="submenu">
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-standards/indian-standards.php'; ?>">Indian Standards (IS)</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-standards/international-standards.php'; ?>">International Standards</a></li>
                                                 </ul>
                                             </li>
                                             ...
                                             <li class="has-arrow">
                                                 <a href="javascript:void(0)">Cables by Type</a>
                                                 <ul class="submenu">
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-type/lv-power-cable.php'; ?>">LV Power Cable</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-type/mv-power-cable.php'; ?>">MV Power Cable</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-type/ehv-power-cable.php'; ?>">EHV Power Cable</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-type/instrumentation-cable.php'; ?>">Instrumentation Cable</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-type/communication-and-data-cable.php'; ?>">Communication & Data Cable</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-type/renewable-energy.php'; ?>">Renewable Energy</a></li>
                                                     <li><a href="<?php echo BASE_URL . 'industries/cables-by-type/others.php'; ?>">Others</a></li>
                                                 </ul>
                                             </li>
                                             <!-- <li><a href="#">Cables</a></li> -->
                                             <li><a href="<?php echo BASE_URL . 'switchgears.php'; ?>">Switchgears</a></li>
                                             <li><a href="<?php echo BASE_URL . 'fans.php'; ?>">Fans</a></li>
                                             <li><a href="<?php echo BASE_URL . 'solar.php'; ?>">Solar</a></li>
                                             <li><a href="<?php echo BASE_URL . 'conduit-accessories.php'; ?>">Conduit & Accessories</a></li>
                                             <li><a href="<?php echo BASE_URL . 'home-appliances.php'; ?>">Home Appliances</a></li>
                                         </ul>
                                     </li>

                                     <!-- 🔹 Dowells Category -->
                                     <li class="has-arrow">
                                         <a href="javascript:void(0)">Dowells</a>
                                         <ul class="submenu">
                                             <li><a href="<?php echo BASE_URL . 'cable-terminal.php'; ?>">Cable Terminal</a></li>
                                             <li><a href="<?php echo BASE_URL . 'gland.php'; ?>">Gland</a></li>
                                             <li><a href="<?php echo BASE_URL . 'crimping-tool.php'; ?>">Crimping Tool</a></li>
                                         </ul>
                                     </li>
                             ...
                             <li>
                                 <a href="<?php echo BASE_URL . 'catalogue.php'; ?>">Catalogue</a>
                             </li>

                             <!-- <li>
                                 <a href="<?php echo BASE_URL . 'achievements.php'; ?>">Achievements</a>
                             </li> -->
                             <li>
                                 <a href="<?php echo BASE_URL . 'pricelist.php'; ?>">Pricelist</a>
                             </li>
                             <li>
                                 <a href="<?php echo BASE_URL . 'assets/images/pdf/MOHIT CATALOGUE.pdf'; ?>" target="_blank">Company Profile</a>
                             </li>
                             <li>
                             ...
                             <!-- <div class="contact-btn">
                                   <div class="rs-banner-btn">
                                       <a class="rs-btn has-theme-orange has-icon has-bg" href="<?php echo BASE_URL . 'contact-us.php'; ?>">Get a
                                           Quote
                                           <span class="icon-box">
             ...
             <div class="offcanvas-content">
                 <div class="offcanvas-top d-flex justify-content-between align-items-center mb-20">
                     <div class="offcanvas-logo">
                         <a class="logo-black" href="<?php echo BASE_URL . 'index.php'; ?>"><img
                                 src="<?php echo BASE_URL . 'assets/images/logo/msc_logo_without_bg.png'; ?>" alt="logo"></a>
                     </div>
                 ...
                 <div class="offcanvas-about mb-30 d-none d-sm-block">
                     <p> The authorized distributor of Polycab India Ltd., your trusted destination for premium
                     ...
                     <ul>
                         <li class="d-flex align-items-center gap-15">
                             ...
                             <div class="offcanvas-contact-text">
                                 <a href="#"> 54/2/16 & 54/2/18 Siddharth Farms <br>Lasudia Mori Dewas Naka <br>
                                     Indore-452010 </a>
                             </div>
                         </li>
                         <li class="d-flex align-items-center gap-15">
                             ...
                             <div class="offcanvas-contact-text">
                                 <a href="tel:+91 9522952267">+91 9522952267 </a>
                             </div>
                         </li>
                         <li class="d-flex align-items-center gap-15">
                             <div class="offcanvas-contact-icon">
                             ...
                             <div class="offcanvas-contact-text">
                                 <a href="mailto:info@mohitscpl.com">info@mohitscpl.com</a>
                             </div>
                         </li>
                     </ul>
                 </div>
