     ...
     <div class="rs-header-area rs-header-two header-transparent has-theme-orange has-border header-new"
         ...
         <div class="container-fluid">
             <div class="rs-header-inner">
                 <div class="rs-header-left index">
                     ...
                     <ul>
                         <li class="d-flex align-items-center gap-15">
                             ...
                             <div class="offcanvas-contact-text">
                                 <a href="#"> 54/2/16 & 54/2/18 Siddharth Farms <br>Lasudia Mori Dewas Naka <br> Indore-452010 </a>
                             </div>
                         </li>
                         <li class="d-flex align-items-center gap-15">
                             <div class="offcanvas-contact-icon">
                             ...
                             <div class="offcanvas-contact-text">
                                 <a href="tel:+919522952267">+91 9522952267</a>
                             </div>
                         </li>
                         <li class="d-flex align-items-center gap-15">
                             <div class="offcanvas-contact-icon">
