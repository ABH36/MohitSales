...
<head>
    ...
    <title>Table Fans - Mohit Sales Corporation Pvt. Ltd.</title>
                            ...
                            <div class="col-12">
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        <div class="col-md-6 text-center">
                                            ...
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/table_fans/ELANZA-PT01.png'; ?>"
                                                alt="Design Series Ceiling Fan" class="product-img">
                                            <h3 class="product-title">ELANZA PT01</h3>
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        <div class="col-md-6 text-center">
                                            ...
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/table_fans/Thunder-Storm-White-Blue.png'; ?>"
                                                alt="Design Series Ceiling Fan" class="product-img">
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/table_fans/Unicorn.png'; ?>"
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/table_fans/Eliana-Table-1.png'; ?>"
                                                alt="THUNDERSTORM Table Fan" class="product-img">
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/table_fans/Cutie.png'; ?>"
                                                alt="CUTIE Table Fan" class="product-img">
                                            <h3 class="product-title">CUTIE</h3>
                                        </div>
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/table_fans/Fantasy-Cabin-Fan.png'; ?>"
                                                alt="FANTACY CABIN FAN" class="product-img">
                                            <h3 class="product-title">FANTACY CABIN FAN</h3>
                                        </div>
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/table_fans/PERSONAL-FAN.png'; ?>"
                                                alt="PEPPY PERSONAL FAN" class="product-img">
                                            <h3 class="product-title">PEPPY PERSONAL FAN</h3>
                                        </div>
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/table_fans/aery.png'; ?>"
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/table_fans/Amaze-brown-table-fan.png'; ?>"
