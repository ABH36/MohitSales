...
<head>
    ...
    <title>Wall Fans - Mohit Sales Corporation Pvt. Ltd.</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/wall_fans/Elanza-PW01-Wall-Fan-2.png'; ?>"
                                                alt="ELANZA PW01 Table Fan" class="product-img">
                                            <h3 class="product-title">ELANZA PW01</h3>
                                        </div>
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/wall_fans/Thunder-Storm-white-blue-Wall-Fan.png'; ?>"
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/wall_fans/Unicorn-Wall-Fan-1.png'; ?>"
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/wall_fans/Fantasy-Wall-Fan-1.png'; ?>"
                                                alt="FANTASY DELUX Table Fan" class="product-img">
                                            <h3 class="product-title">FANTASY DELUX</h3>
                                        </div>
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/wall_fans/Elanza-PW01-Wall-Fan-2 (1).png'; ?>"
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/wall_fans/Thunder-Storm-white-blue-Wall-Fan (1).png'; ?>"
                                                alt="THUNDERSTORM 300 MM Table Fan" class="product-img">
                                            <h3 class="product-title">THUNDERSTORM 300 MM</h3>
                                        </div>
                                ...
                                <div class="card_box">
                                  ...
                                  <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        ...
                                        <!-- LEFT SIDE : IMAGE + TITLE -->
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/wall_fans/Aspire-wall-fan.png'; ?>"
