...
<head>
    ...
    <title>Design Series - Mohit Sales Corporation Pvt. Ltd.</title>
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        <div class="col-md-6 text-center">
                                            ...
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/ceiling_fans/ceiling_fan.png'; ?>"
                                                alt="Design Series Ceiling Fan" class="product-img">
                                            <h3 class="product-title">SUPERIA SP01</h3>
