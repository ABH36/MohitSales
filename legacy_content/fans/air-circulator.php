...
<head>
    ...
    <title>Air Circulator Fans - Mohit Sales Corporation Pvt. Ltd.</title>
                            ...
                            <div class="rs-breadcrumb-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><span>Air Circulator Fans</span></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="row product-wrapper">
                            <div class="col-12">
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/air_circulator/Air-Circulator-Pedestal-Fan-1.png'; ?>"
                                                alt="AIR CIRCULATOR PEDESTAL" class="product-img">
                                            <h3 class="product-title">AIR CIRCULATOR PEDESTAL</h3>
                                        </div>
                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/air_circulator/Air-Circulator-Wall-Fan-2.png'; ?>"
                                                alt="AIR CIRCULATOR WALL" class="product-img">
                                            <h3 class="product-title">AIR CIRCULATOR WALL</h3>
                                        </div>
