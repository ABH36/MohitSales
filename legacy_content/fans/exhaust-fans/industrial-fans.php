                                ...
                                <div class="card_box">
                                    <div class="row align-items-center product-card">
                                        <div class="col-md-6 text-center">
                                            <img src="<?php echo BASE_URL . 'assets/images/our_products/fans/exhaust_fans/industrial_fans/Super-Exhaust-Fan.png'; ?>"
                                                alt="SUPERB EXHAUST" class="product-img">
                                            <h3 class="product-title">SUPERB EXHAUST</h3>
                                        </div>
