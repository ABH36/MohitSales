...
<head>
    ...
    <title>Home Appliances - Mohit Sales Corporation Pvt. Ltd.</title>
                    ...
                    <div class="container">
                        ...
                        <div class="products-grid">
                            ...
                            <div class="product-card">
                                <a href="<?php echo BASE_URL . 'home-appliances/water-heaters.php'; ?>">
                            ...
                            <div class="product-card">
                                <a href="<?php echo BASE_URL . 'home-appliances/irons.php'; ?>">
                                    <img src="<?php echo BASE_URL . 'assets/images/our_products/home_appliances/2.png'?>" alt="Product">
                                    <h3>Irons</h3>
                                    <div class="pricelist-button">
                                        <span class="pricelist-btn">Explore More</span>
                                    </div>
                            ...
                            <div class="product-card">
                                <a href="<?php echo BASE_URL . 'home-appliances/coolers.php'; ?>">
                                    <img src="<?php echo BASE_URL . 'assets/images/our_products/home_appliances/3.png'?>" alt="Product">
                                    <h3>Coolers</h3>
                                    <div class="pricelist-button">
                                        <span class="pricelist-btn">Explore More</span>
                                    </div>
