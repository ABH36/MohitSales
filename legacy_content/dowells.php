...
<head>
    ...
    <title>Dowells - Mohit Sales Corporation Pvt. Ltd.</title>
                    ...
                    <div class="col-xxl-12 col-xl-12 col-lg-12">
                        <div class="rs-breadcrumb-content-wrapper">
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Dowells</h1>
                            </div>
                        ...
                        <div class="products-grid">
                            ...
                            <div class="product-card">
                                ...
                                <a href="<?php echo BASE_URL . 'cable-terminal.php'; ?>">
                                    <img src="assets/images/our_products/dowells/cable_terminal_dowells.png" alt="Product">
                            ...
                            <div class="product-card">
                                <a href="<?php echo BASE_URL . 'gland.php'; ?>">
                                     ...
                                     <img src="assets/images/our_products/dowells/gland_dowells.png" alt="Product">
                                    <h3>Gland</h3>
                                    <div class="pricelist-button">
                                        <span class="pricelist-btn">Explore More</span>
                                    </div>
                            ...
                            <div class="product-card">
                                <a href="<?php echo BASE_URL . 'crimping-tool.php'; ?>">
                                     <img src="assets/images/our_products/dowells/crimping_tool_dowells.png" alt="Product">
                                    <h3>Crimping Tool</h3>
                                    <div class="pricelist-button">
                                        <span class="pricelist-btn">Explore More</span>
                                    </div>
